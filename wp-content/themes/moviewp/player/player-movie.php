...
<html <?php language_attributes(); ?>>
	<head>
		...
		<link rel="stylesheet" href="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/css/warez.css?ver=3.8.6" type="text/css" media='all' />
			...
			<br><br>
				<div class="hostListSelector singleautoembed">
					<div class="hostList active">
						<div class="buttonLoadHost" data-load-embed="<?php echo $id; ?>" data-load-embed-host="superembed"><i class="fa fa-play-circle"></i>
						...
						<div class="buttonLoadHost" data-load-embed="<?php echo $imdb; ?>" data-load-embed-host="frozen"><i class="fa fa-play-circle"></i>
						...
						<div class="buttonLoadHost" data-load-embed="<?php echo $imdb; ?>" data-load-embed-host="videoapi"><i class="fa fa-play-circle"></i>
	...
	<script src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/js/autoembed.js?ver=3.8.8"></script>
	</body>
</html>
	<?php
		} else {
