...
if (window.localStorage && window.location.search.indexOf('?page=configuration') === 0 && jQuery(".themesia-panel ul.nav-tabs li").length > 1 && jQuery(".themesia-panel #submit").length > 0 && jQuery(".themesia-panel ul.nav-tabs li.active a").length > 0){
