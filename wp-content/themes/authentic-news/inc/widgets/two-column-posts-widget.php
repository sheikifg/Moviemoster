	...
	class Ace_News_Two_Column_Posts_Widget extends WP_Widget {
		...
		public function __construct() {
			$ace_news_two_column_posts_widget_ops = array(
				'classname'   => 'two-column-posts ascendoor-widget style-2',
				'description' => __( 'Retrive Two Column Posts Widgets', 'authentic-news' ),
			);
			parent::__construct(
				'ace_news_two_column_widget',
				__( 'Ascendoor Two Column Posts Widget', 'authentic-news' ),
						...
						<div class="main-wrap">
							...
							if ( $query->have_posts() ) :
								...
								while ( $query->have_posts() ) :
									$query->the_post();
									$classes = $j === 1 ? 'grid-layout' : 'list-layout';
									?>
		...
		public function form( $instance ) {
			...
			?>
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'title_1' ) ); ?>"><?php esc_html_e( 'Section Title 1', 'authentic-news' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'category_1' ) ); ?>"><?php esc_html_e( 'Select the category 1 to show posts', 'authentic-news' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'title_2' ) ); ?>"><?php esc_html_e( 'Section Title 2', 'authentic-news' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'category_2' ) ); ?>"><?php esc_html_e( 'Select the category 2 to show posts', 'authentic-news' ); ?></label>
