...
<body <?php body_class(); ?>>
	...
	<div id="page" class="site">
		...
		<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'authentic-news' ); ?></a>
			...
			<div class="ace-news-middle-header <?php echo esc_attr( $header_image ); ?>">
				<?php if ( ! empty( get_header_image() ) ) : ?>
					<div class="header-bg-image">
						<img src="<?php echo esc_url( get_header_image() ); ?>" alt="<?php esc_attr_e( 'Header Image', 'authentic-news' ); ?>">
					</div>	
				<?php endif; ?>
				<div class="section-wrapper">
					...
					<?php if ( ! empty( $ads_image ) ) { ?>
						<div class="middle-header-newsadvert">
							<a href="<?php echo esc_url( $ads_url ); ?>"><img src="<?php echo esc_url( $ads_image ); ?>" alt="<?php esc_attr_e( 'Bigyapaan Image', 'authentic-news' ); ?>"></a>
						</div>
					<?php } ?>
				</div>	
			</div>	
